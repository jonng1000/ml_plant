...
D:\GoogleDrive\machine_learning\GO_features\no_pfam\test1\making_dataset
...
# After adding everything, without aracyc pathways
# the 4363th feature is the class label
# dataset.shape
# Out[20]: (5251, 4363)

dataset.to_csv("dataset_all.txt", sep='\t', na_rep='NA')