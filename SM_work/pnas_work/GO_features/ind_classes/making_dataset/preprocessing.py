...
data_f.loc[:, domains] = data_f.loc[:, domains].astype('Int64')
...
# Only ~11% NaNs in matrix, but they are scatterred around, as deleting
...
# data_f.select_dtypes(include='float64').isnull().values.any()
# False
...
# data_f.shape
# Out[141]: (5251, 8937)
# 8937-4363 = 4574 additional features due to dummy features
