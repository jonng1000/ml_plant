...
# Need to put eta0>0 so just took 0.01 as an arbitary value, otherwise,
# grid search doesn't work for log and SVM
sgd = SGDClassifier(loss='hinge', eta0=.01, class_weight='balanced')
...
#
#           0       0.98      0.57      0.72       290
#           1       0.11      0.79      0.19        19
#
#    accuracy                           0.59       309
#   macro avg       0.54      0.68      0.46       309
#weighted avg       0.92      0.59      0.69       309
#
