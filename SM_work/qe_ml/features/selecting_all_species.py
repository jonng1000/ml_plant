...
genes from all species, with experimental evidence. However, primary GO terms
aren't contained in this input file, as I only downloaded genes with secondary
metaoblism. If I removed this filter in my AmiGO search, it would have ~760k
results, and I can only download max 100k results.
"""
...
df = pd.read_csv('GO_all_species_expt_code.txt', sep='\t', header=None)
