...
Explore tti feature scores from ml workflow
...
DATA_FOLDER = 'D:/GoogleDrive/machine_learning/ml_go_workflow/tti_runs/output'
OUTPUT = 'score04_tti_features.txt'
...
labels04.to_csv(OUTPUT, sep='\t', index=False)