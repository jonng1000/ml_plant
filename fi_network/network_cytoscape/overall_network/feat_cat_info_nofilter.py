...
Modified from original create_feat_cat_info.py script in
D:/GoogleDrive/machine_learning/fi_network/fc_perm test
Did not filter cluster sizes < 3
"""
...
OUTPUT = 'feat_cat_info_nofilter.txt'
...
filtered = df  # Just to avoid changing too much of downstream code
