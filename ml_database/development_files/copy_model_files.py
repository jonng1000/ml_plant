...
Copies models to a new folder, for creation of gzip folder for database upload.
...
def get_path(folder):
    ...
    all_files = [one_file for one_file in temp_files if one_file.endswith('_model')]
    return all_files
