...
FILE = '/mnt/d/GoogleDrive/machine_learning/ml_go_workflow/all_data/ath_homologs.txt'
OUTPUT = 'ath_homologs_info.txt'
...
temp_lst = ['Evolution - homologs in other speceies (hom)'] * len(df)
df.insert(loc=0, column='Type', value=temp_lst)

# Temp list for Description column
temp_lst = ['Presence of A. thaliana homolog in 23 species (plants and algae)'] * len(df)
