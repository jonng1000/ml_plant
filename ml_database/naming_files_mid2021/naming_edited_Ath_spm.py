...
FILE = '/mnt/d/GoogleDrive/machine_learning/ml_go_workflow/all_data/edited_Ath_spm.txt'
OUTPUT = 'edited_Ath_spm_info.txt'
...
temp_lst = ['Specificity of gene expression'] * len(df)
