...
FILE = '/mnt/d/GoogleDrive/machine_learning/ml_go_workflow/all_data/edited_Ath_tpm.txt'
OUTPUT = 'edited_Ath_tpm_info.txt'
...
temp_lst = ['Gene expression'] * len(df)
df.insert(loc=0, column='Type', value=temp_lst)

# Temp list for Description column
temp_lst = ['Level of gene expression - summary statistics'] * len(df)
