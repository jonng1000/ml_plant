...
FILE = '/mnt/d/GoogleDrive/machine_learning/ml_go_workflow/all_data/gwas_features.txt'
OUTPUT = 'gwas_features_info.txt'
...
temp_lst = ['phenotype traits - genome wide association (gwa)'] * len(df)
df.insert(loc=0, column='Type', value=temp_lst)

# Temp list for Description column
temp_lst = ['Genomic loci within genes, correlated with phenotype traits'] * len(df)
