...
Visualises distributions of oob R^2 scores of
continuous features, those which scored well and those which did not

Takes about 5-10min to run
"""
...
g = sns.histplot(data=data_used, x='oob_r_sq', bins=12,
