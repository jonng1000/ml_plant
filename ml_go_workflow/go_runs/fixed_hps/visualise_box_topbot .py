...
FIG = 'grps_tb_box_out.png'
FIG2 = 'grps_tb_box.png'
...
top_50['group'] = 'top_50'
bot_50['group'] = 'bot_50'
topbot = pd.concat([top_50, bot_50])

# This section is for plotting
# To ensure my plotting code can run
data_used = topbot

g = sns.boxplot(x='group', y='Counts', data=data_used)
g.figure.savefig(FIG)
plt.close()

g = sns.boxplot(x='group', y='Counts', showfliers=False, data=data_used)
