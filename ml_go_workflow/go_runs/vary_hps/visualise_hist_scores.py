...
FIG = 'combined_hist.png'
FIG1 = 'high_hist.png'
FIG2 = 'not_high_hist.png'
...
# 119 GO terms are high scoring
not_high = combined_df.loc[~(combined_df['oob_f1'] >= 0.7), :]
# 1260 GO terms are not high scoring
# This section is for plotting
# To ensure my plotting code can run
data_used = combined_df

g = sns.histplot(data=data_used, x='Counts')
g.figure.savefig(FIG)
plt.close()
g = sns.histplot(data=high, x='Counts')
g.figure.savefig(FIG1)
plt.close()
g = sns.histplot(data=not_high, x='Counts')
