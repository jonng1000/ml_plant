...
FOLDER = 'D:/GoogleDrive/machine_learning/ml_go_workflow/hp_test/71classes_od_hp/results/'
...
'''
# Shows the most freq grp of hps from my hp test (high_counts df)
id	score	param_rf__n_estimators	param_rf__max_features	
param_rf__max_depth	param_rf__ccp_alpha	count
66	high	50	0.2	nan	0.001	3
61	high	50	0.2	100.0	0.001	3
'''
...
best_params = high_counts.loc[(high_counts['param_rf__ccp_alpha'] == '0.001') & 
                              (high_counts['param_rf__max_depth'] == '200.0') &
                              (high_counts['param_rf__max_features'] == '0.2') &
                              (high_counts['param_rf__n_estimators'] == '50'), 
                              :]
med_params = med_counts.loc[(med_counts['param_rf__ccp_alpha'] == '0.001') & 
                              (med_counts['param_rf__max_depth'] == '200.0') &
                              (med_counts['param_rf__max_features'] == '0.2') &
                              (med_counts['param_rf__n_estimators'] == '50'), 
                              :]
low_params = low_counts.loc[(low_counts['param_rf__ccp_alpha'] == '0.001') & 
                            (low_counts['param_rf__max_depth'] == '200.0') &
                            (low_counts['param_rf__max_features'] == '0.2') &
                            (low_counts['param_rf__n_estimators'] == '50'), 
                            :]
