...
Plots oob score
Modified from plot_score_compare.py from 
...
DATA_FOLDER2 = './all_results/results_16c_dhp/'

FIG1 = 'compare_16c_odhp_f1.png'
FIG2 = 'boxplot_16c_ohp_f1.png'
...
# Making line plots
# List of score types created, as I can extend it to plot accuracy scores as
# well
score_types = ['oob_f1']
