...
Small range of number of features tested, balanced class weights
RF uses 1 process, grid search uses 5 processes, 5-fold cv
"""
import sys
import pandas as pd
...
scores_file = data_file.split('.')[0] + '_sf_scores.txt'
RUNS = 1
...
rf_grid = {
    'classifier__ccp_alpha': [0.0002],
    'classifier__max_features': [100],
    'param_classifier__n_estimators': [80, 100, 200, 500, 1000]
}
