...
Run model with pipeline and other objects to perform the entire machine 
...
for a_file in os.listdir(DATA_FOLDER):
    ...
    grid = {
        ...
        MODEL_NAME + '__learning_rate': [0.1],
        MODEL_NAME + '__max_depth': [1],
        MODEL_NAME + '__subsample': [0.3],
    }
    """
    grid = {
        MODEL_NAME + '__n_estimators': [50, 100, 200],
        MODEL_NAME + '__learning_rate': [0.001, 0.01, 0.1],
        MODEL_NAME + '__max_depth': [1, 3, 5],
        MODEL_NAME + '__subsample': [0.3, 0.5, 1],
    }
    """
