...
Improved version of logr_16cl.py
"""
import sys
import os
import pandas as pd
...
# Modify this when shifting back to linux
...
for a_file in os.listdir(DATA_FOLDER):
    ...
    grid = {
        ...
        MODEL_NAME + '__C': [0.00001, 0.0001, 0.001, 0.1, 1, 10, 100, 1000],
    }
    """
    grid = {
        MODEL_NAME + '__penalty': ['l2'],
    ...
    fi = gd_sr.best_estimator_.named_steps[MODEL_NAME].coef_
    fi = fi[0]
