...
Processes hp tests results into a format which is convenient for plotting, modified from 
analyse_hp.py in 
D:\GoogleDrive\machine_learning\ml_go_workflow\older_ml_runs\ml_runs_v4\hp_trial_20
"""
import os
import pandas as pd
