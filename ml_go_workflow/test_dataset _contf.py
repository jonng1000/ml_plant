...
Creates a test dataset for testing my ml workflow, for continuous feastures as
class targets
"""
...
contf_labels = data.loc[:, all_cont_feat]
'''
# Eg of class targets
pep_aal, agn_deg_cen
'''

small = contf_labels.iloc[:100, :100]
