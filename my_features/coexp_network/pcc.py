...
patha = 'D:/GoogleDrive/machine_learning/my_features/data_creation_v3/'
filename="ARATH.tpm.av" #Make sure to changet this to your species!
output = patha+'%s.PCC.txt' % filename.split('.')[0]

# Read Matrix and store nominators and denominators
with open(patha+filename, 'r') as fin:
